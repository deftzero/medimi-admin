import { IUser, userData } from './Users';
...
import { ICountry, countryData } from '../countries/Countries';
...
export default function User() {
  ...
  let { id } = useParams();
  const data: IUser | any = userData.find((item: IPatient) => item.id === id)
      ...
      <div className="flex flex-wrap gap-12">
        ...
        <div className="center flex flex-wrap gap-10">
          ...
          <div>
            ...
            <p className='my-1 font-semibold capitalize'>{data.status?.toLowerCase()}</p>
          </div>
        </div>
      </div>
      <div className="right">
